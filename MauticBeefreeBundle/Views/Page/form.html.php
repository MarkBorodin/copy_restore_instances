        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <ul class="bg-auto nav nav-tabs pr-md pl-md">
                    <li class="active">
                        <a href="#beefree-email-container" role="tab" data-toggle="tab">
                            <?php echo $view['translator']->trans('mautic.beefree.form.theme'); ?>
                        </a>
                    </li>
                    <li >
                ...
                <div class="tab-content pa-md">
                    <div class="tab-pane fade in active bdr-w-0" id="beefree-email-container">
                        <div class="row">
                            <div class="col-md-12">
                    ...
                    <div class="tab-pane fade in bdr-w-0" id="theme-container">
                        <div class="row">
                            <div class="col-md-12">
                                <?php echo $view['form']->row($form['template']); ?>
                            </div>
